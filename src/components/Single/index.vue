...
<div  class="single">
<div >
  <el-form ref="searchForm" :model="searchForm" label-width="80px" style="width:100%">
...
<div>
    <el-dialog :visible.sync="dialogFormVisible" style="width:1050px;margin-left:400px;max-height: 700px">
        <el-form ref="insertForm" style="min-height:100px;width:100%">
            <el-form-item  v-for="item in ModuleData.insertform"  :prop="item.name" :label="item.name"  :label-width="formLabelWidth">
          <el-col :span="8" v-if="item.type==='select'">
            <el-select  v-model="item.cvalue"  style="width:150px;" size="mini" @change=change()>
                <el-option v-for="item in item.data" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
         ...
         <el-row >
          <el-col :span="12">
          <el-button size="mini" type="primary" @click="insertForm()" class="marginTop" >确认
          </el-button>
          </el-col>
          <el-col :span="12">
          <el-button size="mini" type="primary" @click="cancle" class="marginTop" >取消
          </el-button>
          </el-col>
        </el-row>
        </el-form-item>
 ...
 data(){
   return{
    ...
    methods:{
      ...
      insertForm(){
          var jsonStr = {}
         for (const item of this.ModuleData.insertform) {
